      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="w-full lg:w-[45%] ">
          <div className="space-y-3">
            {sports?.map((sport) => (
              <div
                key={sport.id}
                className="flex flex-col lg:flex-row  border lg:h-[200px]  p-3 gap-4 hover:bg-sky-900 hover:text-white hover:border-r-8 hover:border-r-cyan-600 rounded-lg"
              >
        ...
        <div className="w-full lg:w-[55%] h-[410px]">
          <iframe
            ...
            height="410"
            src="https://www.youtube.com/embed/uuyLH0QjGik?si=PKBHExYxjyGny7zG"
