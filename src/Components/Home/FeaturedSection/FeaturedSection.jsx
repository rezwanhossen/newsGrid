...
const FeaturedSection = () => {
    ...
    const displayedNews = selectedCategory ? newsData.filter((item) => item.category === selectedCategory) : newsData;

    return (
        <div className="container mx-auto my-16 px-4 lg:px-0">
            <div className="sticky top-16 z-10 bg-white shadow-md py-4 mb-8 border-b">
