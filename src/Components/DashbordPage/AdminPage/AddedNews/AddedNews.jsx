    ...
    <div className="heebo">
      ...
      <div>
        {addedNews?.map((news) => (
          <div
            key={news?._id}
            className="py-4  border-t border-b border-dashed border-gray-500 mx-4 lg:mx-0"
          >
            {/* left side nav */}
            <div className="flex flex-col-reverse lg:flex-row  heebo">
              ...
              <div className="w-full lg:w-[55%] lg:pr-6">
                ...
                <h2 className=" font-bold">{news?.title.slice(0, 50)}...</h2>
                ...
                <div className="mt-2 flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {news?.status === "approved" ? (
                      <button
                        className="btn btn-sm bg-[#1f6892] text-white hover:bg-[#47728b]"
                        disabled
                      >
                        Approved
                      </button>
                      ...
                      <button
                        className="btn btn-sm bg-[#1f6892] text-white hover:bg-[#47728b]"
                        onClick={() =>
                          handleNewsUpdate({ news, status: "approved" })
                        }
                      >
                        Approved
                      </button>
                    ...
                    {news?.status === "rejected" ? (
                      ...
                      <button
                        className="btn btn-sm bg-red-700 hover:bg-red-800 text-white"
                        onClick={() =>
                          handleNewsUpdate({ news, status: "rejected" })
                        }
                      >
                        Rejected
                      </button>
