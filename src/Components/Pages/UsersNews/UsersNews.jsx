    ...
    <div className="bg-base-200">
      <div className="border-4">
        <div className="heebo mt-[100px] lg:mt-10">
          <h1 className="text-2xl font-semibold text-center py-4 bg-white">
            Home / Users News{" "}
          </h1>
        </div>
          ...
          <div>
            <div className="sticky lg:top-36">
              <div className="bg-white flex flex-row justify-between lg:justify-normal lg:flex-col mx-4 lg:mx-0 lg:w-[350px]  rounded p-5">
                <h1 className="text-xl hidden lg:block font-bold lg:border-b-2 lg:border-[#005689] pb-2">
                  News By Categories
                </h1>
                ...
                <div className="px-8 py-3 flex justify-center text-center my-10  w-full">
                  <div>
                    <h1 className="text-2xl font-bold mb-4">
                      Sorry ! No news found related this category
                    </h1>
