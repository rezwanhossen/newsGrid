      ...
      <div className="h-[400px] lg:h-[500px] heebo   w-[100%] bg-black opacity-75 flex justify-center items-center"> 
        ...
        <div className="container mx-auto mt-20">
                ...
                <div className="heebo mt-3 mx-3  md:mx-0">
                    <h1 className="text-3xl font-bold mt-10 mb-6  border-l-[#005689] border-l-8 pl-3">More News</h1>
                </div>
                    ...
                    newsData?.slice(11 , 14).map(news => {
                        return (
                          ...
                          <p className="font-semibold w-full lg:w-[25%]  hidden md:block">
                            ...
                            <IoMdTime className="text-lg"/><span>{news?.publishedAt.slice(0 , 10)}</span>
                            </div>
                          </p>
                          <div className="w-full lg:w-[50%] lg:pr-6 mt-3 md:mt-0">
                            ...
                            <p className="text-justify my-1 heebo text-[15px]">{news?.description?.slice(0, 60)}...</p>
                      ...
                      <div className="border border-[#005689] hidden md:block">
